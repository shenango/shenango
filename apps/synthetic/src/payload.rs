            ...
            fn deserialize<__D>(__deserializer: __D)
             ...
             __D: _serde::Deserializer<'de> {
                ...
                impl <'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    fn visit_seq<__A>(self, mut __seq: __A)
                     ...
                     __A: _serde::de::SeqAccess<'de> {
                        ...
                        _serde::export::Ok(Payload{sleep_us: __field0,
                                                   index: __field1,})
                    }
                    #[inline]
                     ...
                     __A: _serde::de::MapAccess<'de> {
                                    ...
                                    if _serde::export::Option::is_some(&__field0)
                                       {
                                        return _serde::export::Err(<__A::Error
                                                                       as
                                                                       _serde::de::Error>::duplicate_field("sleep_us"));
                                    }
                                    __field0 =
                                    ...
                                    if _serde::export::Option::is_some(&__field1)
                                       {
                                        return _serde::export::Err(<__A::Error
                                                                       as
                                                                       _serde::de::Error>::duplicate_field("index"));
                                    }
                                    __field1 =
                                        _serde::export::Some(match _serde::de::MapAccess::next_value::<u64>(&mut __map)
                                                                 {
                        ...
                        let __field0 =
                            match __field0 {
                                ...
                                _serde::export::None =>
                                match _serde::private::de::missing_field("sleep_us")
                                    {
                                    Result::Ok(val) => val,
                                    Result::Err(err) => {
                                        return Result::Err(From::from(err))
                ...
                _serde::Deserializer::deserialize_struct(__deserializer,
                                                         "Payload", FIELDS,
                                                         __Visitor{marker:
                                                                       _serde::export::PhantomData::<Payload>,
                                                                   lifetime:
